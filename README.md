...
3.	Sample the number of hurricanes during the simulated year using the hurricane model with a negative binomial distribution
4.	For each hurricane in step 2,
...
5.	Repeat steps 2-3 for N number of times (baseline N = 100,000)
